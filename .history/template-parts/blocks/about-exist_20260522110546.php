...
<div class="exist-wrap wp-block-acf-about-exist animate-from-bottom"
     data-exist-title="<?php echo esc_attr($title); ?>"
     data-exist-content="<?php echo esc_attr($content); ?>"
     data-exist-image='<?php echo esc_attr(wp_json_encode($image)); ?>'>
