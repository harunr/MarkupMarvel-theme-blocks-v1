...
$items = get_field('info_items') ?: []; // Grab the full repeater array!
?>

<div class="get-in-touch-wrap wp-block-acf-contact-info"
     data-title="<?php echo esc_attr($title); ?>"
     data-description="<?php echo esc_attr($desc); ?>"
     data-logo='<?php echo esc_attr(wp_json_encode($logo)); ?>'
