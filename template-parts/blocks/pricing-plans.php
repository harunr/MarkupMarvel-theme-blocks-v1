...
$plans = get_field('plans') ?: []; // Grab the full repeater array (including nested features)
?>

<div class="pricing-wrap wp-block-acf-pricing-plans"
     data-plans='<?php echo esc_attr(wp_json_encode($plans)); ?>'>
